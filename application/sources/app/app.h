...
#define AC_DISPLAY_SCREEN_IDLE_INTERVAL					(12000)
#define AC_DISPLAY_WELCOME_TEXT_ANIM_TICK_INTERVAL				(120)
#define AC_DISPLAY_RH_GAME_TICK_INTERVAL				(120)
#define AC_DISPLAY_TITLE_ANIM_TICK_INTERVAL			(150)
#define AC_DISPLAY_TITLE_INTERVAL						(3000)
#define AC_DISPLAY_MENU_ANIM_TICK_INTERVAL				(80)
/* define signal */
enum {
    ...
    AC_DISPLAY_TITLE_ANIM_TICK,
    AC_DISPLAY_TITLE_SHOW_MENU,
